                ...
                <form name="inworksheet-form" id="inworksheet-form" method="post" action="{{route('outworksheet.intreatment')}}">
                    ...
                    <div class="d-flex justify-content-around p-2 bg-light">
                        ...
                        <table class="table table-sm table-striped">
                            <thead>
                                <tr>
                                    <th class="moco-color-success" style="width: 30%">{{__('Part Number')}}</th>
                                    <th class="moco-color-success" style="width: 30%">{{__('Bar Code')}}</th>
                                    <th class="moco-color-success" style="width: 10%">{{__('Quantity')}}</th>
                                    <th class="moco-color-success" style="width: 20%">{{__('Worksheet Quantity')}}</th>
                                    <th class="moco-color-success" style="width: 10%">{{__('Remove')}}</th>
                                </tr>
