...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" <?php if(! \Illuminate\Support\Facades\Auth::check()): ?> class="moco-background" <?php endif; ?>>
    <head>
        ...
        <link href="<?php echo e(asset('3rd/resizable-table-columns-2.0.5/css/resizable-table-columns.min.css')); ?>" rel="stylesheet">
        <!-- CSS MOCO -->
        ...
        <script type="text/javascript" src="<?php echo e(asset('js/moco.random.js')); ?>"></script>
        <!-- Livewire -->
    ...
    <div class="d-flex justify-content-center">
        <div>Developed by MO Consult <i class="fas fa-copyright"></i> <?php echo e(\Carbon\Carbon::now()->year); ?></div>
    </div>
    <?php endif; ?>
