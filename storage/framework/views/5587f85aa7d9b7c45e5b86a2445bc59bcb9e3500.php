        <div class="card">
            ...
            <div class="card-body">
                <form wire:submit.prevent="save" name="store-part-form" id="store-part-form" method="post" action="<?php echo e(route('store.store')); ?>">
                <?php echo csrf_field(); ?>
                <!-- Part Number-->
                    <div class="form-group">
                        <p><?php echo e($part_number); ?></p>
                        <label for="part_number"><?php echo e(__('Part Number')); ?></label>
                        <input wire:model="part_number" type="text" id="part_number" name="part_number" class="form-control" value="<?php echo e(old('part_number')); ?>">
                    </div>
                    <!-- Description -->
                    <div class="form-group">
...
<?php /**PATH /var/www/moco/fassicms/resources/views/livewire/store-part-form.blade.php ENDPATH**/ ?>