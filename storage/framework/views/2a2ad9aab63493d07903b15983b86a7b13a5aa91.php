        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="d-flex justify-content-center" style="width: 100%">
                    <?php echo e(__('Change your password')); ?>
            ...
            <div class="modal-footer">
                <div class="d-flex justify-content-between" style="width: 100%">
                    <div>
                        <a href="#" class="btn btn-primary" id="validate"><?php echo e(__('Validate')); ?></a>
                    </div>
                    <div>
                        <a href="#" class="btn btn-primary" id="cancel"><?php echo e(__('Cancel')); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function (){
        var _url_check_current_password = '<?php echo e(route('password.checkcurrent')); ?>';
        var _url_check_format_password = '<?php echo e(route('password.format')); ?>';
        var _url_change_password = '<?php echo e(route('password.store')); ?>';
        /** ajax setup **/
        $.ajaxSetup({
            headers: {
        ...
        $('#confirm_password').on('keyup',function () {
            if ($(this).val() != "" && $(this).val() != $('#new_password').val()){
                ...
                isInValid('#confirm_password','<?php echo e(__('The value not match with the new password')); ?>');
            } else {
...
<?php /**PATH /var/www/moco/fassicms/resources/views/auth/change.blade.php ENDPATH**/ ?>