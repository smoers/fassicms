                ...
                <form name="customer-form" id="customer-form" method="post" action="<?php echo e($action); ?>" moco-validation>
                    ...
                    <div>
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a href="#contacts" class="nav-link" data-toggle="tab"><?php echo e(__('Contacts')); ?></a>
                            </li>
                        </ul>
                        <div class="tab-content mt-3">
                            ...
                            <div class="tab-pane fade" id="contacts">
                                <?php echo $__env->make('customer.customer-contact-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
