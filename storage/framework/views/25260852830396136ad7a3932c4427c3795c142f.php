        ...
        <div class="card">
            ...
            <div class="card-body">
                <form name="customer-form" id="customer-form" method="post" action="<?php echo e(route('customer.store')); ?>" moco-validation>
                    ...
                    <!-- address optional-->
                    <div class="form-group">
                        <label for="address_optional"><?php echo e(__('Address')); ?></label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" moco-validation>
